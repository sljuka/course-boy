...
export const buttonVariants = cva(
  "inline-flex appearance-none items-center justify-center whitespace-nowrap rounded-md border font-medium transition-[transform,background-color,box-shadow] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      appearance: {
        courseTile:
        ...
        default: "",
        squareTileMd:
          "!w-[9.75rem] h-[9.75rem] !min-w-[9.75rem] shrink-0 flex-col items-center justify-center gap-2 rounded-[1.5rem] border-2 px-3 text-center font-semibold shadow-none",
        squareTile:
      ...
      variant: {
        ...
        ghost:
          "border-transparent bg-transparent text-stone-700 shadow-none hover:bg-stone-100 hover:text-stone-950",
      },
    },
    defaultVariants: {
      appearance: "default",
